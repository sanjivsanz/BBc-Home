package com.automation.phrAutomation.customListner;
...
public class Listener extends TestBase implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		if(!result.isSuccess()){
			...
			try {
				String reportDirectory = new File(System.getProperty("user.dir")).getAbsolutePath() + "/src/main/java/com/automation/phrAutomation//";
